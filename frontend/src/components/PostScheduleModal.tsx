...
export const PostScheduleModal: React.FC<PostScheduleModalProps> = ({
  ...
  }, [selectedDate, selectedHour, selectedMinute, scheduledPosts]);
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        >
          ...
          {/* Prominent Scheduling Time Display */}
          <div className="flex-shrink-0 bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-3 mb-3">
            ...
            >
              {isScheduling ? (
                ...
                <>
                  ...
                  {isMobile ? "Schedule" : "Confirm & Schedule Post"}
                </>
              )}
            </Button>
          </DialogFooter>
