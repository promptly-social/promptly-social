      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="border border-gray-200 shadow-xl bg-white">
          <CardHeader className="text-center pb-4 sm:pb-6">
            ...
            <CardTitle className="text-gray-900 text-xl sm:text-2xl mb-2">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-gray-900 to-gray-800 hover:from-gray-800 hover:to-gray-700 text-white h-12 font-semibold shadow-lg text-base"
            >
            ...
            <div className="text-center">
              ...
              <Link
                to="/login"
                className="text-gray-800 hover:text-gray-900 font-semibold hover:underline text-sm"
              >
                Sign in here
              </Link>
            </div>
