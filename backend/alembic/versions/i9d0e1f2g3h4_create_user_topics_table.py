...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_user_topics_topic'), 'user_topics', ['topic'], unique=False)
    # Create unique constraint on user_id + topic to prevent duplicates
    op.create_index('ix_user_topics_user_id_topic_unique', 'user_topics', ['user_id', 'topic'], unique=True)
