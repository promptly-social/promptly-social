variable "project_id" {
  ...
  type        = string
  default     = "promptly-social-production"
}
...
variable "app_sa_email" {
  ...
  type        = string
  default     = "promptly-social-app-sa-production@promptly-social-production.iam.gserviceaccount.com"
}
